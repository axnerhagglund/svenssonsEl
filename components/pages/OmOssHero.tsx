...
import { omOssIntro } from '@/lib/data/omOssPage'
import { OpenContactButton } from '@/components/contact/OpenContactButton'
import { Button } from '@/components/ui/Button'

export function OmOssHero() {
  const { ctaPrimary } = siteConfig.hero
  const { imageSrc, imageAlt } = siteConfig.about
  const { phone, phoneHref } = siteConfig.contact

  return (
    <section className="bg-dark border-b border-border/30" aria-label="Om oss, introduktion">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3 mb-7">
              ...
              <Button href="#om-oss-berattelse" variant="secondary" size="lg">
                Vår berättelse
              </Button>
            </div>
            <a
